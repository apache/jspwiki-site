...
> [!CAUTION]
>
> Incompatible changes found while checking backward compatibility of version `3.0.1-SNAPSHOT` with the previous version `2.12.3`.
...
- **New archives**:
  - ![jspwiki-bootstrap 3.0.1-SNAPSHOT](https://img.shields.io/badge/jspwiki_bootstrap-3.0.1_SNAPSHOT-blue "jspwiki-bootstrap 3.0.1-SNAPSHOT")
...
*Generated on: 2026-08-25 22:48:10.197+0000*.
