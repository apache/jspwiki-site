...
- **New archives**:
  - ![jspwiki-tika-searchprovider 2.12.4-SNAPSHOT](https://img.shields.io/badge/jspwiki_tika_searchprovider-2.12.4_SNAPSHOT-blue "jspwiki-tika-searchprovider 2.12.4-SNAPSHOT")
...
|-----------|-----------|-------|----------------------|---------|--------|---------------------|-----------------------|
| Unchanged | `public`  | Class | `TikaSearchProvider` | null    | JDK 11 | ![Not serializable] | ![No changes]         |
...
*Generated on: 2025-07-30 19:05:33.750+0000*.
