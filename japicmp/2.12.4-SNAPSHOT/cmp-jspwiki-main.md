...
- **New archives**:
  - ![jspwiki-main 2.12.4-SNAPSHOT](https://img.shields.io/badge/jspwiki_main-2.12.4_SNAPSHOT-blue "jspwiki-main 2.12.4-SNAPSHOT")
...
| Unchanged | [org.apache.wiki.tags.CalendarTag]                               | ![Not serializable] | ![No changes]         |
...
| Status    | Modifiers | Type  | Name          | Extends         | JDK    | Serialization       | Compatibility Changes |
|-----------|-----------|-------|---------------|-----------------|--------|---------------------|-----------------------|
| Unchanged | `public`  | Class | `CalendarTag` | [`WikiTagBase`] | JDK 11 | ![Not serializable] | ![No changes]         |
...
| Unchanged | `final` `public` |          | `int`  | `doWikiStartTag`()              |             | [`IOException`] | ![No changes]         |
| Unchanged | `public`         |          | `void` | `initTag`()                     |             |                 | ![No changes]         |
| Unchanged | `public`         |          | `void` | `setAddindex`(`boolean`)        |             |                 | ![No changes]         |
