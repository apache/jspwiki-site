...
> [!NOTE]
>
> No incompatible changes found while checking backward compatibility of version `2.12.3` with the previous version `2.12.2`.
...
- **Old archives**:
  - ![jspwiki-210-test-adaptees 2.12.2](https://img.shields.io/badge/jspwiki_210_test_adaptees-2.12.2-blue "jspwiki-210-test-adaptees 2.12.2")
- **New archives**:
...
*Generated on: 2025-07-30 19:59:17.473+0200*.
