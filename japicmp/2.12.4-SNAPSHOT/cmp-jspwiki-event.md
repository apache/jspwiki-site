...
- **New archives**:
  - ![jspwiki-event 2.12.4-SNAPSHOT](https://img.shields.io/badge/jspwiki_event-2.12.4_SNAPSHOT-blue "jspwiki-event 2.12.4-SNAPSHOT")
...
|-----------|-----------|-------|-------------------|---------------|--------|---------------|-----------------------|
| Unchanged | `public`  | Class | `WikiEngineEvent` | [`WikiEvent`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers           | Type  | Name        | Extends         | JDK    | Serialization | Compatibility Changes |
|-----------|---------------------|-------|-------------|-----------------|--------|---------------|-----------------------|
| Unchanged | `public` `abstract` | Class | `WikiEvent` | [`EventObject`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers        | Type | Name               | Extends     | JDK    | Serialization | Compatibility Changes |
|-----------|------------------|------|--------------------|-------------|--------|---------------|-----------------------|
| Unchanged | `final` `public` | Enum | `WikiEventEmitter` | [`Enum<E>`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers           | Type      | Name                | Extends    | JDK    | Serialization       | Compatibility Changes |
|-----------|---------------------|-----------|---------------------|------------|--------|---------------------|-----------------------|
| Unchanged | `public` `abstract` | Interface | `WikiEventListener` | [`Object`] | JDK 11 | ![Not serializable] | ![No changes]         |
...
| Status    | Modifiers        | Type  | Name               | Extends    | JDK    | Serialization       | Compatibility Changes |
|-----------|------------------|-------|--------------------|------------|--------|---------------------|-----------------------|
| Unchanged | `final` `public` | Class | `WikiEventManager` | [`Object`] | JDK 11 | ![Not serializable] | ![No changes]         |
...
| Status    | Modifiers | Type  | Name            | Extends       | JDK    | Serialization | Compatibility Changes |
|-----------|-----------|-------|-----------------|---------------|--------|---------------|-----------------------|
| Unchanged | `public`  | Class | `WikiPageEvent` | [`WikiEvent`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers | Type  | Name                  | Extends           | JDK    | Serialization | Compatibility Changes |
|-----------|-----------|-------|-----------------------|-------------------|--------|---------------|-----------------------|
| Unchanged | `public`  | Class | `WikiPageRenameEvent` | [`WikiPageEvent`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers        | Type  | Name                | Extends       | JDK    | Serialization | Compatibility Changes |
|-----------|------------------|-------|---------------------|---------------|--------|---------------|-----------------------|
| Unchanged | `final` `public` | Class | `WikiSecurityEvent` | [`WikiEvent`] | JDK 11 | ![Compatible] | ![No changes]         |
...
| Status    | Modifiers        | Type  | Name            | Extends       | JDK    | Serialization | Compatibility Changes |
|-----------|------------------|-------|-----------------|---------------|--------|---------------|-----------------------|
| Unchanged | `final` `public` | Class | `WorkflowEvent` | [`WikiEvent`] | JDK 11 | ![Compatible] | ![No changes]         |
...
*Generated on: 2025-07-30 19:05:32.499+0000*.
