...
- **New archives**:
  - ![jspwiki-markdown 2.12.4-SNAPSHOT](https://img.shields.io/badge/jspwiki_markdown-2.12.4_SNAPSHOT-blue "jspwiki-markdown 2.12.4-SNAPSHOT")
...
| Status    | Modifiers | Type  | Name             | Extends | JDK    | Serialization       | Compatibility Changes |
|-----------|-----------|-------|------------------|---------|--------|---------------------|-----------------------|
| Unchanged | `public`  | Class | `WikiHtmlInline` | null    | JDK 11 | ![Not serializable] | ![No changes]         |
...
*Generated on: 2025-07-31 11:56:01.189+0000*.
