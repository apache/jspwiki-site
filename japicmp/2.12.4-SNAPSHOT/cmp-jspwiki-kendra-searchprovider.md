...
- **New archives**:
  - ![jspwiki-kendra-searchprovider 2.12.4-SNAPSHOT](https://img.shields.io/badge/jspwiki_kendra_searchprovider-2.12.4_SNAPSHOT-blue "jspwiki-kendra-searchprovider 2.12.4-SNAPSHOT")
...
|-----------|-----------|-------|------------------------|------------|--------|---------------------|-----------------------|
| Unchanged | `public`  | Class | `KendraSearchProvider` | [`Object`] | JDK 11 | ![Not serializable] | ![No changes]         |
...
*Generated on: 2025-07-30 19:05:32.541+0000*.
