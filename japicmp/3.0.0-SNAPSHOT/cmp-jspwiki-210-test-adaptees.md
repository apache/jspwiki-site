...
> [!NOTE]
>
> No incompatible changes found while checking backward compatibility of version `3.0.0-SNAPSHOT` with the previous version `2.12.3`.
...
- **New archives**:
  - ![jspwiki-210-test-adaptees 3.0.0-SNAPSHOT](https://img.shields.io/badge/jspwiki_210_test_adaptees-3.0.0_SNAPSHOT-blue "jspwiki-210-test-adaptees 3.0.0-SNAPSHOT")
...
*Generated on: 2026-06-04 18:35:49.331+0000*.
